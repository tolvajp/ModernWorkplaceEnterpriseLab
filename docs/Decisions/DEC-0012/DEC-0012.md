...
### DEC-0012-01 — Functional scope and definition of “done”
...
### DEC-0012-02 — Public domain and internal separation
...
### DEC-0012-03 — Refactoring freedom and contract stability
...
### DEC-0012-04 — Module input model
...
### DEC-0012-05 — Output and logging behavior
...
### DEC-0012-06 — Error handling and idempotency model
...
### DEC-0012-07 — Authentication and authorization boundaries
...
### DEC-0012-08 — Secrets and passwords are prohibited
...
### DEC-0012-09 — Automated validation
...
- It enables safe refactoring: DEC-0012 explicitly allows internal refactoring; broad test coverage is what makes that freedom low-risk.
...
### DEC-0012-10 — Naming conventions
...
### DEC-0012-11 — Error handling defaults and call discipline
...
**Rationale**  
Enforcing terminating errors guarantees deterministic behavior in automation and prevents silent failure propagation.  

---

### DEC-0012-12 — Least privilege permission preconditions
...
### DEC-0012-13 — Standardized command invocation wrapper
...
Rationale
Centralizing meaningful invocations behind a single wrapper makes debugging deterministic by ensuring every significant call and its parameters are visible in the verbose stream, while avoiding noise from non-semantic PowerShell pipeline operations and preventing “wrapper of wrapper” complexity.

---

### DEC-0012-14 — Module versioning policy
